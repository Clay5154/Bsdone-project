...
public final class StatsLeadersOrderBy {
    ...
    private static final Set<String> BATTING = Set.of("gp", "pa", "ab", "r", "h", "doubles", "triples", "hr", "insideParkHr", "rbi", "bb", "so", "sb", "cs", "avg", "obp", "slg", "ops", "tb");
    private static final Set<String> PITCHING = Set.of("w", "l", "era", "gp", "gs", "cg", "sv", "svo", "ip", "pitchH", "pitchR", "er", "pitchHr", "pitchInsideParkHr", "pitchHbp", "pitchBb", "pitchSo", "whip", "pitchPa", "pitchBf", "np");
    private static final Set<String> FIELDING = Set.of("gp", "gs", "inn", "tc", "po", "a", "e", "dp", "tcPct");
