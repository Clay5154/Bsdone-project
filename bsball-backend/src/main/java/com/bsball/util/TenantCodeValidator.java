...
public final class TenantCodeValidator {
    private static final Set<String> RESERVED = Set.of("admin", "user", "users", "default", "api", "assets", "src", "files", "www", "static", "public", "server", "health", "sys", "system", "favicon.ico", "root", "null", "undefined", "portal", "docs", "login", "logout", "auth", "oauth", "index", "404");
