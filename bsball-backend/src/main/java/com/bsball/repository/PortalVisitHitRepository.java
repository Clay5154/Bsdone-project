...
JpaSpecificationExecutor<PortalVisitHit> {
    ...
    public static interface CityMetricsProjection {
    ...
    public static interface MonthlyMetricsProjection {
        public int getY();
    ...
    public static interface ProvinceCityBucketCountProjection {
        public String getProvinceName();

        public long getCityBucketCount();
    }

    public static interface ProvinceMetricsProjection {
        public String getProvinceName();
    ...
    public static interface VisitDailyProjection {
    ...
    public static interface VisitHourlyProjection {
