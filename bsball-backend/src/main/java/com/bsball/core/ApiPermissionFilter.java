...
implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        try {
            ...
            boolean readLike = ApiPermissionFilter.isReadLikeHttpMethod(req.getMethod());
    ...
    private boolean isWhitelisted(String path) {
        ...
        List<String> prefixes = Arrays.stream(this.whitelistStr.split(",")).map(String::trim).filter(s -> !s.isEmpty()).toList();
