...
public class TenantProperties {
    ...
    public static class HostMapping {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof HostMapping)) {
                return false;
            }
            TenantProperties.HostMapping other = (HostMapping)o;
            ...
            String this$baseHost = this.getBaseHost();
            String other$baseHost = other.getBaseHost();
            return !(this$baseHost == null ? other$baseHost != null : !this$baseHost.equals(other$baseHost));
        }

        @Generated
        protected boolean canEqual(Object other) {
            return other instanceof HostMapping;
        }
        ...
        public int hashCode() {
            ...
            result = result * 59 + ($baseHost == null ? 43 : $baseHost.hashCode());
            return result;
        }

        @Generated
        public String toString() {
            return "TenantProperties.HostMapping(enabled=" + this.isEnabled() + ", baseHost=" + this.getBaseHost() + ")";
        }
    }
}
