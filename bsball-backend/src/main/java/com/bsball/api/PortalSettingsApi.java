...
public class PortalSettingsApi {
    ...
    public Result<Map<String, Object>> get() {
        ...
        boolean portalDevtoolsGuard = PortalSettingsApi.readBool((Map)cfg, out, "portalDevtoolsGuard", (boolean)true);
        out.put("portalDevtoolsGuard", portalDevtoolsGuard);
        boolean subFallback = portalDevtoolsGuard;
        out.put("portalDevtoolsGuardOverlay", PortalSettingsApi.readBool((Map)cfg, out, "portalDevtoolsGuardOverlay", (boolean)subFallback));
        out.put("portalDevtoolsGuardDebuggerTrap", PortalSettingsApi.readBool((Map)cfg, out, "portalDevtoolsGuardDebuggerTrap", (boolean)subFallback));
        out.put("portalDevtoolsGuardCopyrightNotice", PortalSettingsApi.readBool((Map)cfg, out, "portalDevtoolsGuardCopyrightNotice", (boolean)subFallback));
