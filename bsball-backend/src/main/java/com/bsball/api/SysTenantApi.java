...
public class SysTenantApi {
    ...
    public Result<Map<String, Object>> scopeOptions(@RequestParam Long tenantId) {
        ...
        return Result.ok(this.sysTenantManageService.scopeOptions(uid.longValue(), tenantId.longValue()));
    }
    ...
    public Result<List<Map<String, Object>>> myTenants() {
        ...
        List<SysUserTenant> uts = this.sysUserTenantRepository.findByUserIdAndDeletedAtIsNull(uid);
