...
public class SysResourceApi {
    ...
    public Result<Map<String, Object>> upload(@RequestParam(value="file") MultipartFile file) {
        try {
            ...
            return Result.ok(Map.of("id",created.getId(), "url", (Object)(created.getUrl() != null ? created.getUrl() : ""), "path", (Object)(created.getPath() != null ? created.getPath() : ""), "name", (Object)(created.getName() != null ? created.getName() : file.getOriginalFilename())));
        }
