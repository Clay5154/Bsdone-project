...
public class JwtService {
    ...
    public String createToken(Long userId, Long tenantId) {
        ...
        if (this.props.getAudience() != null && !this.props.getAudience().isBlank()) {
            b = (JwtBuilder)b.audience().add(this.props.getAudience().trim()).and();
        }
        return b.compact();
    }
    ...
    public record TokenAuth(Long userId, Long tenantId, String rejectMessage, String rejectDetail) {
        public boolean rejectAsUnauthorized() {
            return this.userId == null && this.rejectMessage != null;
        }
