...
public class SysIpAccessRuleService {
    ...
    public SysIpAccessRule create(Long requestedTenantId, IpAccessRulePayload p) {
        ...
        e.setCreatedBy(uid);
        e.setUpdatedBy(uid);
        SysIpAccessRule saved = (SysIpAccessRule)this.sysIpAccessRuleRepository.save(e);
    ...
    public void update(long id, IpAccessRulePayload p) {
        SysIpAccessRule e = (SysIpAccessRule)this.sysIpAccessRuleRepository.findById(id).orElseThrow(() -> new IllegalArgumentException("\u89c4\u5219\u4e0d\u5b58\u5728"));
        ...
        this.sysIpAccessRuleRepository.save(e);
        this.ipAccessPolicyService.refresh();
    }
    ...
    public void delete(long id) {
        ...
        this.sysIpAccessRuleRepository.delete(e);
        this.ipAccessPolicyService.refresh();
    }
